...
class Pokemon {
  ...
  setSprites() {
    if (this.id >= 1 && this.id <= 999) {
      this.sprite.src = `https://img.pokemondb.net/sprites/home/normal/${this.name}.png`;
      this.spriteShiny.src = `https://img.pokemondb.net/sprites/home/shiny/${this.name}.png`;
    } else if (this.id > 999) {
      this.sprite.src = `https://img.pokemondb.net/sprites/home/normal/${this.name}.png`;
